...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Download Gmail attachments based on regex filters"
    )
    ...
    parser.add_argument(
        "--auth",
        metavar="EMAIL",
        help="Authenticate the specified email account"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        metavar="N",
        help="Override the number of days to search back"
    )
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output directory for attachments (overrides config setting)"
    )
